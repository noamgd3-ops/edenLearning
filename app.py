...
CORRECT_MESSAGES = [
    ...
    "וואלה, ידעת! מי ציפה? 😏",
    "נכון! אל תתרגלי לזה 😂",
    "הפועל הזה לא ידע מה פגע בו 😤",
    "שייקספיר היה גאה. קצת. 🎭",
    "בום שקט. 💣",
    "אוקספורד מאשרת! 📚",
    "כן, בדיוק! כאילו למדת או משהו 😅",
    "הדיקשנרי הנהן בראשו ✅",
    "ידעת?? ידעת!! 😱",
    "מרשים. עדיין לא מאמינה, אבל מרשים 🤨",
    "הפועל הזה כרע ברך 🫡",
    "נכון! אפילו האנגלים היו מסכימים 🇬🇧",
    "לקח לך שנייה אבל הגעת לשם! 🏁",
    "זה נכון! תרשמי לעצמך 📝",
    "פגעת! פגעת ממש! 🎯",
    "מי את ואיך את יודעת את זה?! 🤩",
    "הצלחת להפתיע אפילו אותי 😳",
    "חיה! 🔥🔥🔥",
    "ידעת בלי לחשוב פעמיים? כל הכבוד 👏",
    "הפועל ברח ואת תפסת אותו! 🏃‍♀️",
    "כן! בדיוק! כך! 💥",
    "חשבתי שתטעי. הפתעת אותי 😂",
    "זאת תשובה מנצחת! 🥇",
    "גם אני הייתי עונה ככה. כנראה. 😌",
    "יצאת מהפארק! ⚾",
    "ישר מהמוח לתשובה! 🧠➡️✅",
    "טוב, הפעם ידעת. אני עוקבת 👀",
    "וואו, רגע, זה נכון? זה נכון!! 🤯",
    "את אלופה ואני מתעקשת על זה 👑",
    "הלכת על זה בלי פחד! 💪",
    "נכון כמו שעון שוויצרי ⏱️",
    "סוויס. טוטאל. 🇨🇭",
    "מלכת הפועלים הלא-סדירים 👸",
    "את עושה את זה להיראות קל 😎",
    "הפועל הזה לא יסתכן איתך יותר 😂",
    "מושלם! ועכשיו הבאה 😏",
    "נכון! ועכשיו תשכחי את זה לשבוע 😂",
    "הפלת את הפועל! 🥊",
    "הידיים יודעות לכתוב נכון! 🙌",
    "ענית לפני שסיימתי לחשוב 😮",
    "זאת אמת! נכון לחלוטין! ✅",
    "לא ציפיתי. ציפיתי. ידעתי! 😂",
    "10 מתוך 10, לא שואלים שאלות 💯",
    "הפועל מניח נשק ✌️",
    "זאת הייתה התשובה! בדיוק זאת! 🎉",
    "גאונה שקטה 🤫🧠",
    "המוח עובד! מי ידע? 🧠",
    "שייקספיר מחייך מהשמיים 🎭✨",
    "ה-Oxford English Dictionary עדכן עמוד בשבילך 📖",
    "את בדיוק כמו ChatGPT, רק יפה יותר 🤖💅",
    "נכון!! תני לי רגע לעכל 😌",
    "מאה אחוז! גם ה-0% מתרשמים 💯",
    "גמרת את הפועל הזה. גמרת אותו. 🔥",
    "הלכת על הסיכוי ויצא לך! 🎲✅",
    "ידעת! מי לימד אותך?! (אני. אני לימדתי אותך) 😂",
    "הפועל הזה כבר לא מפחיד אותך 😤",
    "מושלמת! עכשיו ביצה מטוגנת 🍳",
    "שגרירת האנגלית! 🇬🇧👸",
    "הצלחת להרשים פועל. זה לא קל. 😂",
    "את אלופה ואת תישארי אלופה 🏆",
    "מדהים! ואפילו בלי רמז 🕵️‍♀️",
    "הפועל הזה נכנע! 🏳️",
    "תנצחי אותי לא תוכלי, את כבר מנצחת 😏",
    "חכמה, יפה ומצליחה. מה עוד? ✨",
    "נכון בלי היסוס! כזאת את 💥",
    "כן! כן! כן! 🥳",
    "הפועל הזה עכשיו חבר שלך 🤝",
    "תזכרי את הרגע הזה 📸",
    "עשית את זה נראה קל מדי 😎",
    "מלכה. פשוט מלכה. 👑",
    "ממש עכשיו הפועל כתב לך תודה 📩",
    "את מי שאני רוצה להיות 😂✨",
    "ידעת! ולא ברמז! 💪",
    "שגרת דרכון אנגלי מחכה לך 🛂🇬🇧",
    "הפועל הזה לא יעז לחזור 😤",
    "חיה על זה! 🙌🙌🙌",
    "המוח שלך עבד שעות נוספות ושווה היה 🧠💡",
    "הכי טובה בכיתה! (כיתה של אחת, אבל עדיין) 😂",
    "נכון! קחי כוכב 🌟",
    "הצלחת! ואני רוצה שתדעי שאני גאה. קצת. 😌",
    "הבינה המלאכותית מניפה דגל לבן 🤖🏳️",
    "הפועל הזה עכשיו שלך! קחי אותו! 🎁",
    "וואאאאו! לא ידעתי שאת מסוגלת 😂",
    "נכון! ועכשיו אל תשכחי 😇",
]
